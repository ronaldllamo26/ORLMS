...
<aside class="no-print print:hidden orlms-sidebar bg-primary-dark border-r border-black/20 flex flex-col" id="main-sidebar">
    ...
    <!-- Mobile Drawer Top Brand Header (Shown inside drawer on mobile) -->
    <div class="h-[56px] min-h-[56px] bg-[#122840] border-b border-white/10 flex items-center px-4 gap-3 shrink-0 md:hidden">
