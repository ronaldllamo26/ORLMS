        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="<?= APP_ROOT_URL ?>/resolution/view/<?= $resolution['id'] ?? 0 ?>">
                        <?= htmlspecialchars($resolution['resolution_no'] ?? 'N/A') ?>
                    </a>
                </li>
            ...
            <p class="page-subtitle">
                Editing <?= htmlspecialchars($resolution['resolution_no'] ?? 'N/A') ?>
...
<form action="<?= APP_ROOT_URL ?>/resolution/edit/<?= $resolution['id'] ?? 0 ?>"
    ...
    <div class="row row-2-1" style="align-items:start;">
        ...
        <div>
            ...
            <div style="background-color:var(--color-primary); color:#fff;
                ...
                <span>
                    Resolution No. <strong><?= htmlspecialchars($resolution['resolution_no'] ?? 'N/A') ?></strong>
                    &mdash; Filed on <?= date('F d, Y', strtotime($resolution['date_filed'] ?? 'now')) ?>
                </span>
            </div>
        ...
        <div>
            ...
            <div class="card" style="margin-bottom:20px; border-left:4px solid #dc3545;">
                <div class="card-body" style="padding:16px 18px;">
                    ...
                    <a href="<?= APP_ROOT_URL ?>/resolution/delete/<?= $resolution['id'] ?? 0 ?>"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?= APP_ROOT_URL ?>/resolution/submit/<?= $resolution['id'] ?? 0 ?>"
